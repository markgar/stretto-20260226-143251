...
- [x] Add `tests/Stretto.Api.Tests` xUnit test project (net10.0); add project reference to Stretto.Api; add a placeholder test class `HealthEndpointTests` with a single test `Placeholder_Passes` that asserts `true`; add the test project to the solution
