...
- Name: /program-years/new renders input with data-testid="name-input"
- Location: /app/e2e/program-years-validation.spec.ts:28:5
...
Call log:
  ...
  - waiting for getByTestId('name-input')
    ...
    at /app/e2e/program-years-validation.spec.ts:32:27
```
