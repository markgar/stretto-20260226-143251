...
- Name: J-1: Smoke — Login and Navigate the App Shell >> sidebar shows Program Years nav link
- Location: /app/e2e/milestone-04a-validation.spec.ts:29:7
...
Locator: getByTestId('nav-program-years').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByTestId('nav-program-years').first()

    at /app/e2e/milestone-04a-validation.spec.ts:35:27
```
