...
- Name: J-1: Smoke — Login and Navigate the App Shell >> clicking Program Years nav link loads without JS error
- Location: /app/e2e/milestone-04a-validation.spec.ts:51:7
...
Call log:
  - waiting for getByTestId('nav-program-years').first()
    ...
    at /app/e2e/milestone-04a-validation.spec.ts:61:19
```
