...
- Name: clicking "New Program Year" link on /program-years navigates to /program-years/new
- Location: /app/e2e/program-years-validation.spec.ts:68:5
...
Locator: getByTestId('add-program-year-button')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for getByTestId('add-program-year-button')

    at /app/e2e/program-years-validation.spec.ts:73:25
```
