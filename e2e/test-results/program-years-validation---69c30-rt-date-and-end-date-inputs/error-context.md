...
- Name: /program-years/new has start-date and end-date inputs
- Location: /app/e2e/program-years-validation.spec.ts:61:5
...
Locator: getByTestId('start-date-input')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for getByTestId('start-date-input')

    at /app/e2e/program-years-validation.spec.ts:64:54
```
