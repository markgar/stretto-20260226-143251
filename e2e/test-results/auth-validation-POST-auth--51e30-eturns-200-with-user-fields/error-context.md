...
- Name: POST /auth/login with valid email returns 200 with user fields
- Location: /app/e2e/auth-validation.spec.ts:5:5
...
Expected: 200
Received: 401
    at /app/e2e/auth-validation.spec.ts:10:29
```
