...
- Name: [J-1] Dashboard shows org name My Choir after login
- Location: /app/e2e/venues-validation.spec.ts:62:5
...
Locator: getByText('My Choir')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('My Choir')

    at /app/e2e/venues-validation.spec.ts:71:44
```
